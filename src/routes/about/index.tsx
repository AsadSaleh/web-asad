		...
		<div className="background-grid">
			<main className="mx-auto w-screen p-4 md:p-6">
				...
				<section className="mx-auto max-w-3xl">
					...
					<p className="mt-3 text-lg dark:text-slate-300">
						Yup, itu dia waktunya. Sehari setelah lebaran idul adha. Tanggal
						yang mengubah segalanya. Dari seorang tanpa penghasilan, menjadi
						seorang yang bisa menghasilkan uang sendiri. Dari seorang yang tidak
						punya pekerjaan, menjadi seorang yang bisa bekerja. Dari seorang
						yang tidak punya masa depan, menjadi seorang yang punya masa depan.
						Dari seorang yang tidak punya tujuan, menjadi seorang yang punya
						tujuan. Dari seorang yang tidak punya mimpi, menjadi seorang yang
						punya mimpi.
						<br />
					...
					<p className="mt-3 text-lg dark:text-slate-300">
						...
						lebih setelah gue lulus kuliah. Nah, dari situ gue belajar ngoding.
						5 hari seminggu, 8 jam sehari. Selama 6 bulan. Yang gue pelajari
						mulai dari HTML, CSS, JavaScript, dan terakhir React. Setelah gue
						bisa React, gue bikin 3 website sederhana. 1 buat nampilin informasi
						cuaca, 1 untuk nampilin infographics, 1 lagi lupa buat apa. Ini
						kayaknya gue kerjain dalam waktu 1 bulan. Ini disebut portofolio
						ternyata.
					</p>
					<p className="mt-3 text-lg dark:text-slate-300">
						...
						Ternyata selama ini gue dikader untuk menjadi programmer. Gue seneng
						banget bisa kerja sebagai programmer.
					</p>
					<p className="mt-3 text-lg dark:text-slate-300">
					...
					<div className="mt-4 rounded-md bg-stone-200 px-6 py-4 dark:bg-stone-800 dark:text-stone-200">
						...
						that helps startups/companies outsource their tech needs. We work
						with clients including PwC, Midtrans, Akseleran, Transfez, etc. Tech
						stack includes: React, Redux, ReduxForm, React Native, TypeScript,
						Apollo GraphQL.
					</div>
					<p className="mt-3 text-lg dark:text-slate-300">
					...
					<p className="mt-3 text-lg dark:text-slate-300">
						...
						front-end yang akan digunakan di proyek. Salah satu produk yang kami
						kerjakan adalah ERP untuk SMEs. Dibungkus menjadi solusi web dan
						mobile app yang dijual sebagai SaaS yang menyediakan ERP dengan
						harga terjangkau untuk UMKM Indonesia. Di sini saya pegang
						aplikasinya menggunakan React Native, yang berinteraksi dengan
						backend GraphQL menggunakan Apollo Client.
					</p>
					...
					<div className="mt-4 rounded-md bg-stone-200 px-6 py-4 dark:bg-stone-800 dark:text-stone-200">
						...
						providing financial, compliance & supply chain services to over
						20,000 low-income schools. I was a part of the engineering team,
						tasked with developing & maintaining the apps & services. Tech stack
						including: Flutter, React, NextJS, Go, NodeJS, Android (Java), and
						Redis.
						<p className="mt-4 font-bold">Key achievements:</p>
						<ol className="list-inside list-decimal">
							<li>
								I maintain an existing Android and NodeJS app for student
								payment. We successfully decreased the number of crashes
								significantly.
							</li>
							<li>
							...
							<li>
								Build internal web-based tools to help the sales team generate
								MoU documents on the fly.
							</li>
							<li>
					...
					<p className="mt-3 text-lg dark:text-slate-300">
						...
						data to be saved even though there is no internet connection, then
						it will automatically sync to our DB when the connection is back
						online. The experience is really thrilling because our boss wanted
						this feature in MVP, but we&apos;re clueless at that time, because
						Flutter is new to all of us. With extensive discussion with peers,
						we managed to pull it off in like 3 weeks time. The first 2 weeks is
						like banging my head around the wall. Everything seems too hard to
						work. However, after several iteration, it clicked and we can write
						the simple yet effective implementation. We tested it, it worked,
					...
					<p className="mt-3 text-lg dark:text-slate-300">
						...
						3-months online course to 20+ students in Digitalent Scholarship
						(DTS) 2021, a program held by Indonesia&apos;s Ministry of
						Communication & Informatics. Course material consists of delivering
						theory through online class & mentoring student&apos;s final
						project.
					</p>
					...
					<div className="mt-4 rounded-md bg-stone-200 px-6 py-4 dark:bg-stone-800 dark:text-stone-200">
						...
						notification service SaaS- from scratch to production in record
						time.
					</div>
					<p className="mt-3 text-lg dark:text-slate-300">
					...
					<p className="mt-3 text-lg dark:text-slate-300">
						...
						web3 applications. I&apos;m learning new things here and I have a
						fair amount of control of the project.
					</p>
					<p className="mt-3 text-lg dark:text-slate-300">
						In this role, I lerned new technologies, such as Web3 itself,
						Supabase and Stripe. I feel just like my time in early careers, when
						everything is new and the world is a vast unknown place. I also
						learned a lot about the blockchain, the terms used in crypto world,
						and basic things in blockchain that I think I know, but turns out I
						don&apos;t know. Overall, I&apos;m happy with my time here.
					</p>
					<p className="mt-3 text-lg dark:text-slate-300">
					...
					<p className="mt-3 text-lg dark:text-slate-300">
						It&apos;s been a month since I left Mainstream. To be without a job
						is hard. How do we keep our head sharp?
					</p>
					<p className="mt-3 text-lg dark:text-slate-300">
					...
					<p className="mt-3 text-lg dark:text-slate-300">
						2 months later I created an online learning course from scratch
						called{" "}
						<a className="text-orange-500" href="https://tanggabelajar.id">
							Tangga Belajar
						</a>
						&nbsp;which focuses on self-paced code learning, similar to
						LeetCode. The site is up and running. It focuses on helping fellow
						Indonesians so all content is in Bahasa Indonesia. It has a generous
						free course with 100 topics and questions, and a paid course coming
						soon.
					</p>
					<p className="mt-3 text-lg dark:text-slate-300">
