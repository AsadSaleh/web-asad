...
export default function RetinaEntryPoint() {
	...
	return (
		<div className="bg-black text-white h-min-screen min-h-screen pb-20">
			<main className="md:w-11/12 lg:w-10/12 xl:w-4/6 mx-auto p-4 md:p-0">
				{/* Title Section */}
				<div className="pt-20 lg:mb-4 flex flex-col gap-1">
					<h1 className="text-2xl">Is your display Retina?</h1>
					<p className="text-md text-gray-200">
						Retina display is a condition where a screen is super sharp that
						your eyes cannot see individual pixels.
					</p>
					<p className="text-sm text-gray-400 mb-4">
						We usually want to achieve this metric so that our monitor or
						laptops are looking sharp.
					</p>
				</div>
								...
								<div>
									...
									<div className="flex gap-1 items-center justify-start">
										...
										<input
											...
											onChange={(e) =>
												setScreenResolutionHeight(e.target.value)
											}
										/>
										<span>px</span>
									</div>
						...
						{result.status !== "idle" && (
							<>
								...
								<p className="text-sm text-gray-400">
									Penjelasan: <br />
									<span>
										&quot;Retina Distance&quot; adalah jarak terdekat dimana
										layar kamu akan mulai menjadi retina. Apabila kamu
										menggunakan device dengan jarak lebih dekat dari angka di
										atas, maka sensasi &apos;Retina Display&apos; tidak akan
										didapatkan. Sebaliknya, apabila kamu menggunakan device
										dengan jarak &gt;= {retinaDistanceInInch} in, maka layar
										akan menjadi &apos;Retina Display&apos;.
									</span>
									<br />
									<span>
