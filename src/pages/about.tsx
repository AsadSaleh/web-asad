      ...
      <main className="mx-auto max-w-3xl p-6">
        ...
        <div className="bg-stone-600 p-4 rounded mb-2">
          ...
          <code>
            ...
            bikin 3 website sederhana. 1 buat nampilin informasi cuaca, 1 untuk
            nampilin infographics, 1 lagi lupa buat apa. Ini kayaknya gue
            kerjain dalam waktu 1 bulan. Ini disebut portofolio ternyata. Dulu
            gue belum tau. Tapi dengan gue buat ini, temen gue cukup yakin gue
            bisa mulai kerja. Nah, setelah itu gue mulai internship di kantor
            temen gue selama 2 bulan. Setelah internship dan cocok, gue mulai
            kerja sebagai Junior Frontend Developer. Alhamdulillah.
            <br />
            <br />
        ...
        <p className="text-lg mb-2 tracking-wide">
          ...
          product. As this is the first time I worked, I put myself as &quot;the
          dumbest person&quot; in the room, I asked a lot of things! And it
          helped me to grow really quickly as a software engineer. <br />
          ...
          projects. The product called Moodah --one of the products I loved the
          most here-- is a web and mobile app we sell as a SaaS which provides
        ...
        <p className="text-lg mb-4 tracking-wide">
          ...
          not learning enough. I know my potential is limitless. Then I decided
          that I need to move to a new company: IDN. I came to IDN as a mobile
          developer. But right now I&apos;m happy to call myself just a software
          engineer. This is because, during my time here, I had to switch
          between product teams and technologies several times. I&apos;ll try to
          highlight the most important ones here, as the full summary of my
          journey is available on my CV. <br />
